...
wizard_resources <- c(
  ...
  "docs/instructions/EU_SAE_Download_Instructions_5_2_0_rc_6_wizard_5_7.pdf",
  "docs/instructions/EU_SAE_User_Guide_5_2_0_rc_6_wizard_5_7.pptx"
)
