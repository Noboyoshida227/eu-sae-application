...
`github.com/Noboyoshida227/eu-sae-application`
Every time you commit and push in GitHub Desktop, a snapshot of the package
folder goes here. The release page on GitHub,
`github.com/Noboyoshida227/eu-sae-application/releases`, is where colleagues
...
```powershell
python tools\bump_version.py 5.2.0-rc.6-wizard.5.7-greece --release-name EU_SAE_520_w6
```
...
```
## 5.2.0-rc.6-wizard.5.7-greece - 2026-09-10
...
In *Choose a tag* pick `v5.2.0-rc.6-wizard.5.7-greece` (or type it and click
...
`github.com/Noboyoshida227/eu-sae-application/releases/tag/v5.2.0-rc.6-wizard.5.7-greece`.
